...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ({ ...props }) => (
          <ChevronLeft className="h-4 w-4 text-black dark:text-white dark:hover:text-black" />
        ),
        IconRight: ({ ...props }) => (
          <ChevronRight className="h-4 w-4 text-black dark:text-white dark:hover:text-black" />
        ),
      }}
      {...props}
    />
