...
const RegisterPage = () => {
  return (
    <section className="container relative xl:h-screen">
      <div
        className="container mx-auto py-10 justify-between lg:pr-12 relative h-full
         w-full flex flex-col xl:flex-row gap-8"
      >
        <motion.div
          ...
          className="relative bg-primary shadow-xl border border-[#646464]
           p-4 text-[15px] flex flex-col
        rounded-[20px] xl:h-[max-content] h-[20%] gap-3 xl:w-[35%] 
        w-full order-2 xl:order-none"
        >
          <h2
